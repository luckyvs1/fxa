...
- [API endpoints](#api-endpoints)
  - [Account](#account)
    ...
    - [PUT /account/metrics/ecosystemAnonId (:lock: oauthToken)](#put-accountmetricsecosystemanonId)
...
#### POST /account/metrics/ecosystemAnonId
...
- `code: 400, errno: 163`:
  Token does not contain the valid correct scope.
